...
global $product, $woocommerce_loop, $voisen_opt, $voisen_shopclass, $voisen_viewmode;
...
if($voisen_shopclass=='shop-fullwidth') {
	if(isset($voisen_opt)){
		$woocommerce_loop['columns'] = $voisen_opt['product_per_row_fw'];
		$colwidth = round(12/$woocommerce_loop['columns']);
	}
	$classes[] = ' item-col col-xs-12 col-sm-4 col-md-'.$colwidth ;
} else {
	if(isset($voisen_opt)){
		$woocommerce_loop['columns'] = $voisen_opt['product_per_row'];
		$colwidth = round(12/$woocommerce_loop['columns']);
	}
...
<div <?php post_class( $classes ); ?>>
	<div class="product-wrapper">
		...
		<div class="list-col4 <?php if($voisen_viewmode=='list-view'){ echo ' col-xs-12 col-sm-4';} ?>">
		...
		<div class="list-col8 <?php if($voisen_viewmode=='list-view'){ echo ' col-xs-12 col-sm-8';} ?>">
			<div class="gridview">
