...
<article id="post-<?php the_ID(); ?>" <?php post_class($blogcolumn); ?>>
	...
	<?php 
		if ( is_single() ) { ?>
			<div class="post-thumbnail"><?php echo do_shortcode(get_post_meta( get_the_ID(), 'voisen_featured_post_value', true )); ?></div>
	...
	<?php if ( !is_single() ) { ?>
		<div class="post-thumbnail">
			<?php echo do_shortcode(get_post_meta( get_the_ID(), 'voisen_featured_post_value', true )); ?>
		</div>
	<?php } ?>
	<?php endif; ?>
